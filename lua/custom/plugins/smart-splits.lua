return {
  ...
  lazy = false,
  config = function()
    vim.keymap.set('n', '<A-r>', require('smart-splits').start_resize_mode, { desc = 'Move focus down' })
    -- Move between splits
    ...
    vim.keymap.set('n', '<leader>j', require('smart-splits').swap_buf_down, { desc = 'Swap with left panel' })
    vim.keymap.set('n', '<leader>k', require('smart-splits').swap_buf_up, { desc = 'Swap with left panel' })
    vim.keymap.set('n', '<leader>l', require('smart-splits').swap_buf_right, { desc = 'Swap with left panel' })
  end,
}
