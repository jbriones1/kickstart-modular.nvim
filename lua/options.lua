...
-- Auto-read files so buffers update if they're changed externally
vim.o.autoread = true
...
-- Tabs insert 2 spaces instead of a tab character
vim.o.tabstop = 2
vim.o.expandtab = true
vim.o.softtabstop = 2
vim.o.shiftwidth = 2

-- Session Options, set for autosessions plugin
